...
| `GET` | `/api/auth/me` | - | `{ user: {id, name, email, role} }` | Yes |
...
| `GET` | `/api/tickets` | - | `{ tickets: [...] }` | Yes |
| `GET` | `/api/tickets/pending` | `?agent_id=` (optional) | `{ cases: [...] }` | Yes |
| `GET` | `/api/tickets/resolved` | `?agent_id=` (optional) | `{ cases: [...] }` | Yes |
